class ProductsController < ApplicationController
  ...
  private
    ...
    def product_params
      params.require(:product).permit(:inid, :sku, :title, :qt, :cost_price, :price,:variants_attributes =>[:id, :product_id, :sku, :quantity, :price,:variant_inid, :cost_price, :supplier, :weight, :opt_title, :supplier_id, :_destroy])
    end
end
